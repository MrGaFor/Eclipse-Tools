...
namespace BuildReportTool
{
	...
	/// <c>SerializationException: TileType 'UnityEditor.Build.Reporting.BuildReport' in Assembly 'UnityEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null' is not marked as serializable.</c><br/><br/>
	///
	...
	public class UnityBuildReport : BuildReportTool.IDataFile
	{
		...
		/// <summary>
		/// TileType of build that the project was configured to, at the time that UnityBuildReport was collected.
		/// </summary>
