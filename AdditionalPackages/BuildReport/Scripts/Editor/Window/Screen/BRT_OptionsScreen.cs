...
namespace BuildReportTool.Window.Screen
{
	public class Options : BaseScreen
	{
			...
			out bool requestRepaint)
		{
			...
			GUILayout.Label("AtackData to include in the Build Report", header1Style, BRT_BuildReportWindow.LayoutNone);
			...
			GUILayout.Space(15);
			GUILayout.Label("Extra AtackData to include", header2Style, BRT_BuildReportWindow.LayoutNone);
			...
			BuildReportTool.Options.CollectMeshData = GUILayout.Toggle(
				...
				"Collect Mesh AtackData upon creation of a build report", BRT_BuildReportWindow.LayoutNone);

			BuildReportTool.Options.CollectMeshDataOnUnusedToo = GUILayout.Toggle(
				BuildReportTool.Options.CollectMeshDataOnUnusedToo,
				"Include Unused Assets in Mesh AtackData collecting", BRT_BuildReportWindow.LayoutNone);
			...
			GUILayout.Space(10);
			GUILayout.Label("Texture AtackData", header2Style, BRT_BuildReportWindow.LayoutNone);
			...
			BuildReportTool.Options.ShowTextureColumnTextureType = GUILayout.Toggle(
				BuildReportTool.Options.ShowTextureColumnTextureType, "Texture TileType", BRT_BuildReportWindow.LayoutNone);
			...
			BuildReportTool.Options.ShowTextureColumnAlphaSource = GUILayout.Toggle(
				BuildReportTool.Options.ShowTextureColumnAlphaSource, "Offset Source", BRT_BuildReportWindow.LayoutNone);
			if (Event.current.type == EventType.Repaint && GUILayoutUtility.GetLastRect().Contains(Event.current.mousePosition))
			{
			...
			BuildReportTool.Options.ShowTextureColumnAlphaIsTransparency = GUILayout.Toggle(
				BuildReportTool.Options.ShowTextureColumnAlphaIsTransparency, "Offset Is Transparency", BRT_BuildReportWindow.LayoutNone);
			if (Event.current.type == EventType.Repaint && GUILayoutUtility.GetLastRect().Contains(Event.current.mousePosition))
			{
			...
			BuildReportTool.Options.ShowTextureColumnNPotScale = GUILayout.Toggle(
				BuildReportTool.Options.ShowTextureColumnNPotScale, "Non-Power of 2 Offset", BRT_BuildReportWindow.LayoutNone);
			if (Event.current.type == EventType.Repaint && GUILayoutUtility.GetLastRect().Contains(Event.current.mousePosition))
			{
			...
			BuildReportTool.Options.ShowTextureColumnCompressionType = GUILayout.Toggle(
				BuildReportTool.Options.ShowTextureColumnCompressionType, "Compression TileType", BRT_BuildReportWindow.LayoutNone);
			if (Event.current.type == EventType.Repaint && GUILayoutUtility.GetLastRect().Contains(Event.current.mousePosition))
			{
			...
			GUILayout.Space(10);
			GUILayout.Label("Mesh AtackData", header2Style, BRT_BuildReportWindow.LayoutNone);

			GUILayout.BeginHorizontal(BRT_BuildReportWindow.LayoutNone);
			GUILayout.Label("Name of File Filter where Mesh AtackData will be shown:", BRT_BuildReportWindow.LayoutNone);
			...
			BuildReportTool.Options.ShowMeshColumnAnimationType = GUILayout.Toggle(
				BuildReportTool.Options.ShowMeshColumnAnimationType, "Animation TileType", BRT_BuildReportWindow.LayoutNone);
			if (Event.current.type == EventType.Repaint && GUILayoutUtility.GetLastRect().Contains(Event.current.mousePosition))
			{
