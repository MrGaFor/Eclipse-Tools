	...
	public static class AssetDependencyGenerator
	{
			...
			bool recursiveGetDependencies = false)
		{
			...
			foreach (var pair in assetDependencies)
			{
				...
				{
					++endlessLoopGuard;
					if (endlessLoopGuard >= 9999) // that ought to be enough for real-world usage (Mini hope)
					{
						break;
					}
					...
					if (usersFlattened.Count >= 2)
					{
						...
						if (userAsset.IndentLevel > 1)
						{
							...
							{
								Debug.LogFormat(
									"=========================================================\nChecking for cyclic dependencies for {0} at _index {1}\nLooking for Indent Level {2}",
							...
							{
								Debug.LogFormat(
									"=========================================================\nDone checking for cyclic dependencies for {0} at _index {1}",
