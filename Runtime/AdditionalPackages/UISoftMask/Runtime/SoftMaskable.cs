...
namespace Coffee.UISoftMask
{
    ...
    public class SoftMaskable : MonoBehaviour, IMaterialModifier, IMaskable
    {
        ...
        [Tooltip("The mask graphic.")]
        [SerializeField]
        private SoftMask m_Mask;
        ...
        Material IMaterialModifier.GetModifiedMaterial(Material baseMaterial)
        {
            ...
            var softMaskDepth = m_Mask ? m_Mask.softMaskDepth : -1;
            ...
            if (useStencil)
            {
                ...
                {
                    threshold = m_Mask.softnessRange.average;
                }
            }
            ...
            var hash = new Hash128(
                ...
                (uint)m_Mask.softMaskBuffer.GetInstanceID(),
            ...
            MaterialRepository.Get(hash, ref _maskableMaterial,
                ...
                (baseMaterial, m_Mask.softMaskBuffer, _softMaskDepth, _stencilBits, isStereo));
            Profiler.EndSample();
...
#endif
            _maskableMaterial.SetInt(s_AllowDynamicResolution, m_Mask.allowDynamicResolution ? 1 : 0);
            _maskableMaterial.SetInt(s_AllowRenderScale, m_Mask.allowRenderScale ? 1 : 0);
        ...
        private void RecalculateStencilIfNeeded()
        {
            ...
            var useStencil = UISoftMaskProjectSettings.useStencilOutsideScreen;
            _stencilBits = Utils.GetStencilBits(transform, false, useStencil, out _mask, out SoftMask softMask);
            if (softMask) m_Mask = softMask;
        }
        ...
        {
            hideFlags = !Mathf.Approximately(power, 1f)
                ? HideFlags.None
                : HideFlags.DontSave;
        }
