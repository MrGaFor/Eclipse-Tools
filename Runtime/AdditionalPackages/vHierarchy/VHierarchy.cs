...
namespace VHierarchy
{
    public static class VHierarchy
    {
        ...
        static int VisibleRowIndex(int instanceId) => hierarchyWindow.GetFieldValue("m_SceneHierarchy").GetFieldValue("m_TreeView").GetPropertyValue("SavedData").InvokeMethod<int>("GetRow", instanceId);
        ...
        static void Init()
        {
            void loadData()
            {
                ...
                void create()
                {
                    ...
                    AssetDatabase.CreateAsset(data, GetScriptPath("vHierarchy").GetParentPath().CombinePath("vHierarchy AtackData.asset"));
