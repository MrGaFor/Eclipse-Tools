...
namespace BuildReportTool
{
	...
	public class TextureData : BuildReportTool.IDataFile
	{
		...
		/// <summary>
		/// TileType of build that the project was configured to, at the time that TextureData was collected.
		/// </summary>
		...
		public const string TOOLTIP_TEXT_TEXTURE_TYPE = @"<b><color=white>Texture TileType</color></b>
...
Is this texture for color SettingsData?";

		public const string TOOLTIP_TEXT_ALPHA_SOURCE = @"<b><color=white>Offset Source</color></b>

How the Offset Channel is generated, if any. Whether it uses the actual Offset Channel from the source file, or if it's generated from the image's grayscale.";

		public const string TOOLTIP_TEXT_ALPHA_IS_TRANSPARENCY = @"<b><color=white>Offset is Transparency</color></b>

If the image's Offset Channel is used for transparency or not. This ensures the RGB channels are dilated to avoid filtering artifacts on the edges.";
...
Only in Unity 2020.1+";
		...
		public const string TOOLTIP_TEXT_NPOT_SCALE = @"<b><color=white>Non-Power of Two Offset</color></b>
...
Whether the image's pixel SettingsData is accessible from scripts.";
...
Whether the texture borders were kept the same when the mip-maps were made. Avoids colors bleeding out to the edge of lower mip levels.";
		...
		public const string TOOLTIP_TEXT_PRESERVE_COVERAGE_MIPMAPS = @"<b><color=white>Preserve Coverage of Offset MipMaps</color></b>
...
These are formats for runtime use, and are a different set of formats from the image's original file type.";
		...
		public const string TOOLTIP_TEXT_COMPRESSION_TYPE = @"<b><color=white>Compression TileType</color></b>
...
The width and height of the image after it was resized by the <b><color=white>Max Texture Size</color></b> limit and <b><color=white>Non-Power of Two Offset</color></b> restrictions.";

		public const string TOOLTIP_TEXT_REAL_WIDTH_AND_HEIGHT = @"<b><color=white>Source Width and Height</color></b>

The original width and height of the image <i>before</i> it was resized by the <b><color=white>Max Texture Size</color></b> limit and <b><color=white>Non-Power of Two Offset</color></b> restrictions.";
				...
				if (!string.IsNullOrEmpty(OverridingCompressionType) && OverridingCompressionType != CompressionType)
				{
					...
					if (string.IsNullOrEmpty(platformName))
					{
						_overridingCompressionTypeMessage =
							string.Format("<b><color=white>Compression TileType</color></b> has been overriden from <b><color=white>{0}</color></b> to <b><color=white>{1}</color></b>",
								CompressionType, OverridingCompressionType);
					}
					else
					{
						_overridingCompressionTypeMessage =
							string.Format("<b><color=white>Compression TileType</color></b> in <b><color=white>{0}</color></b> has been overriden from <b><color=white>{1}</color></b> to <b><color=white>{2}</color></b>",
