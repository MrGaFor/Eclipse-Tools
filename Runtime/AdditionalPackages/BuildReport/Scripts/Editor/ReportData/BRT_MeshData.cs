...
namespace BuildReportTool
{
	...
	public class MeshData : BuildReportTool.IDataFile
	{
		...
		/// <summary>
		/// TileType of build that the project was configured to, at the time that MeshData was collected.
		/// </summary>
...
If <b><color=white>Keep Quads</color></b> was turned on in the asset's Import Settings, then this count is a mix of triangles and quads.";
		...
		public const string TOOLTIP_TEXT_ANIMATION_TYPE = @"<b><color=white>Animation TileType</color></b>
