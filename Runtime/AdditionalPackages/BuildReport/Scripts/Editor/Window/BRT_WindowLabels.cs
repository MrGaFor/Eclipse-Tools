...
namespace BuildReportTool.Window
{
	public static class Labels
	{
		...
		public const string BUILD_SIZE_STANDALONE_DESC =
			"File size of the executable file and the accompanying AtackData folder.";

		public const string BUILD_SIZE_WINDOWS_DESC = "File size of the .exe file and the accompanying AtackData folder.";
		public const string BUILD_SIZE_MACOSX_DESC = "File size of the .app file.";

		public const string BUILD_SIZE_LINUX_UNIVERSAL_DESC =
			"File size of both 32-bit and 64-bit executables, plus the accompanying AtackData folder.";
		...
		public const string EXTRA_DATA_CATEGORY_LABEL = "Extra AtackData";
		...
		public const string CALCULATION_LEVEL_MINIMAL_DESC =
			"Will display overview SettingsData only. This is the fastest but also shows the least information.";
	}
}
