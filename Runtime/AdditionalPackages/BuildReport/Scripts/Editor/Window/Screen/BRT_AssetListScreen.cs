	...
	StringBuilder _debugText;
		...
		void DrawOverlay(BuildReportTool.BuildInfo buildReportToDisplay, bool isOverlay = true)
		{
			...
			if (_showColumnOptions)
			{
				...
				_columnLabel.text = "Texture AtackData Columns:";
				rect.size = toggleHeaderStyle.CalcSize(_columnLabel);
				GUI.Label(rect, _columnLabel, toggleHeaderStyle);
				rect.y += rect.height - 2;
				...
				_columnLabel.text = "Texture TileType";
				rect.size = GUI.skin.toggle.CalcSize(_columnLabel);
				rect.width += TOGGLE_EXTRA_WIDTH;
				...
				_columnLabel.text = "Offset Source";
				rect.size = GUI.skin.toggle.CalcSize(_columnLabel);
				rect.width += TOGGLE_EXTRA_WIDTH;
				...
				_columnLabel.text = "Offset Is Transparency";
				rect.size = GUI.skin.toggle.CalcSize(_columnLabel);
				rect.width += TOGGLE_EXTRA_WIDTH;
				...
				_columnLabel.text = "Non-Power of 2 Offset";
				rect.size = GUI.skin.toggle.CalcSize(_columnLabel);
				rect.width += TOGGLE_EXTRA_WIDTH;
				...
				_columnLabel.text = "Compression TileType";
				rect.size = GUI.skin.toggle.CalcSize(_columnLabel);
				rect.width += TOGGLE_EXTRA_WIDTH;
				...
				_columnLabel.text = "Mesh AtackData Columns:";
				rect.size = toggleHeaderStyle.CalcSize(_columnLabel);
				GUI.Label(rect, _columnLabel, toggleHeaderStyle);
				rect.y += rect.height - 2;
				toggleYStart = rect.y;
				...
				_columnLabel.text = "Animation TileType";
				rect.size = GUI.skin.toggle.CalcSize(_columnLabel);
				rect.width += TOGGLE_EXTRA_WIDTH;
			...
			BuildReportTool.FileFilterGroup fileFilterGroupToUse)
		{
			...
			// _index of first asset to show, for current page.
			...
			BuildReportTool.AssetList list, BuildReportTool.FileFilterGroup filter, int length)
		{
			...
			//_debugText.AppendFormat("mousePos: {0}\n", mousePos.ToString());
				...
				if (Event.current.type == EventType.Repaint)
				{
					...
					//
					// Mini don't know if that is too much processing,
					// so Mini'm leaving the code the way it is right now.
		...
		_debugText.AppendFormat("_assetListEntryHovered: {0}\n", _assetListEntryHoveredIdx.ToString());
			...
			if (showTextureColumns)
			{
				if (BuildReportTool.Options.ShowTextureColumnTextureType)
				{
					DrawTextureDataColumn(viewOffset, len,
						BuildReportTool.TextureData.DataId.TextureType, "TileType",
				...
				{
					DrawTextureDataColumn(viewOffset, len,
						BuildReportTool.TextureData.DataId.AlphaSource, "Offset Source",
						true, false, list, textureData,
						assetListToUse, ref _assetListScrollPos);
				}
				...
				{
					DrawTextureDataColumn(viewOffset, len,
						BuildReportTool.TextureData.DataId.AlphaIsTransparency, "Offset is Transparency",
						true, false, list, textureData,
						assetListToUse, ref _assetListScrollPos);
				}
				...
				{
					DrawTextureDataColumn(viewOffset, len,
						BuildReportTool.TextureData.DataId.CompressionType, "Compression TileType",
						true, false, list, textureData,
						assetListToUse, ref _assetListScrollPos);
				}
				...
				{
					DrawTextureDataColumn(viewOffset, len,
						BuildReportTool.TextureData.DataId.NPotScale, "Non-Power Of 2 Offset",
						true, false, list, textureData,
						assetListToUse, ref _assetListScrollPos);
				}
			...
			if (showMeshColumns)
			{
				...
				{
					DrawMeshDataColumn(viewOffset, len,
						BuildReportTool.MeshData.DataId.AnimationType, "Animation TileType",
						true, false, list, meshData,
						assetListToUse, ref _assetListScrollPos);
				}
