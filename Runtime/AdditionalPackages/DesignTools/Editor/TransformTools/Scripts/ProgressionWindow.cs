...
namespace PluginMaster
{
    ...
    public class PositionProgressionWindow : ProgressionWindow
    {
        ...
        [UnityEditor.MenuItem("Tools/Plugin Master/Transform Tools/Position Progression", false, 1300)]
    ...
    {
        [UnityEditor.MenuItem("Tools/Plugin Master/Transform Tools/Rotation Progression", false, 1300)]
    ...
    {
        [UnityEditor.MenuItem("Tools/Plugin Master/Transform Tools/Scale Progression", false, 1300)]
