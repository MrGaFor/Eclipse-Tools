...
namespace PluginMaster
{
    ...
    {
        [UnityEditor.MenuItem("Tools/Plugin Master/Transform Tools/Homogenize Spacing", false, 1450)]
    ...
    {
        [UnityEditor.MenuItem("Tools/Plugin Master/Transform Tools/Homogenize Rotation", false, 1450)]
    ...
    public class HomogenizeScaleWindow : HomogenizeToolWindow
    {
        ...
        [UnityEditor.MenuItem("Tools/Plugin Master/Transform Tools/Homogenize Scale", false, 1450)]
