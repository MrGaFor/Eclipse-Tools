...
{
    [HideMonoScript]
    public class EffectorTextMeshPro : IEffectorComponent
    {
        #region Data
        ...
        [SerializeField, HideLabel, OnValueChanged("FloatUpdate", IncludeChildren = true), ShowIf("ThisFloat")] private EffectorComponentFuncData<TMPro.TextMeshPro, FuncList, float> _dataFloat; public virtual void FloatUpdate() { _dataColor.Func = _dataFloat.Func; _dataString.Func = _dataFloat.Func; base.MarkDirty(); }
        [SerializeField, HideLabel, OnValueChanged("StringUpdate", IncludeChildren = true), ShowIf("ThisString")] private EffectorComponentFuncData<TMPro.TextMeshPro, FuncList, string> _dataString; public virtual void StringUpdate() { _dataColor.Func = _dataString.Func; _dataFloat.Func = _dataString.Func; base.MarkDirty(); }
        ...
        public override IEffectorData Data => _data; private EffectorComponentFunc<TMPro.TextMeshPro, FuncList> _data => ThisFloat ? _dataFloat : ThisColor ? _dataColor : ThisString ? _dataString : null;
        ...
        public override async UniTask PlaySmoothAsync()
        {
            ...
            await PlaySmoothCustomAsync(_dataString.Value);
        ...
        public override async UniTask PlaySmoothCustomAsync(string value, float duration)
        {
            if (!gameObject.activeSelf)
                PlayMomentCustom(value);
            else if (SmoothStringPart(value, duration)) await EffectTween;
        }
