...
namespace EC.Effects
{
    ...
    public class EffectorImage : IEffectorComponent
    {
        ...
        public override IEffectorData Data => _data; private EffectorComponentFunc<UnityEngine.UI.Image, FuncList> _data => ThisFloat ? _dataFloat : ThisColor ? _dataColor : null;
