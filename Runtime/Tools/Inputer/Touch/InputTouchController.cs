...
namespace EC.Inputer
{
    ...
    [HideMonoScript]
    public class InputTouchController : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerMoveHandler
    {
        #region RESULT EVENT
        [SerializeField] private List<InputTouchComponent> _events;
        ...
        {
            InputTouchComponent[] components = gameObject.GetComponents<InputTouchComponent>();
